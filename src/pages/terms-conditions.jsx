            ...
            <div className="text-center">
              <div className="">
                ...
                <div className="max-w-lg mx-auto mt-5 text-sm text-black dark:text-gray-200">
                  Please read these Terms and Conditions (&quot;Agreement&quot;) carefully before accessing or using the Shap Cab mobile application (&quot;App&quot;) and its associated services. This Agreement sets forth the legally binding terms and conditions for your use of the App.
                </div>
              </div>
            </div>
          </div>
