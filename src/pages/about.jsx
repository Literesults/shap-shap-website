    ...
    <Layout active={'About Us'}>
      ...
      <div className="px-3">
        <div className="max-w-3xl mx-auto sm:flex gap-5 sm:gap-16 md:gap-x-28 relative bottom-7 sm:bottom-16 grid grid-cols-2 sm:grid-cols-4 justify-center py-4 sm:py-9 dark:bg-gray-800 dark:text-white bg-white rounded-lg shadow-md">
          ...
          <div className="text-center">
            <div className="font-[1000] md:text-2xl">24+</div>
            <div className="text-xs sm:text-xs md:text-base">Riders</div>
          </div>
          <div className="text-center">
            <div className="font-[1000] md:text-2xl">200+</div>
            <div className="text-xs sm:text-xs md:text-base">Trips Covered</div>
          </div>
          <div className="text-center">
            <div className="font-[1000] md:text-2xl">$10.1B</div>
            <div className="text-xs sm:text-xs md:text-base">Amount Raised</div>
          </div>
        </div>
      </div>
