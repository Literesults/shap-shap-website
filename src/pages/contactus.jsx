                    ...
                    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 mb-28">
                        ...
                        <div className="md:col-span-2 flex items-center bg-gray-100 dark:bg-gray-600 rounded-3xl px-5 pb-5 pt-28 lg:pl-36 lg:py-5 lg:pr-5">
                            <div className="space-y-7 w-full">
                                ...
                                <form className="px-3 md:px-16 py-8 space-y-3">
                                    <FormInput Icon={<BiUserCircle size={'24px'}/>} name={'fullname'} placeholder={'Enter Fullname'} type={'text'} />
                                    <FormInput Icon={<BiUserCircle size={'24px'}/>} name={'contact'} placeholder={'Enter Phone or Mail'} type={'text'} />
