                    ...
                    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className=" space-y-4">
                            <div className="grid grid-cols-5 gap-3">
                                <div className="col-span-3 h-44"><Image src={img1}  alt="" srcSet="" className="w-full h-full" draggable="false" /></div>
                                <div className="h-44 col-span-2"><Image src={img2}  alt="" srcSet="" className="w-full h-full" draggable="false" /></div>
                            </div>
                            <div className="grid grid-cols-5 gap-3">
                                <div className="h-44 col-span-2"><Image src={img3}  alt="" srcSet="" className="w-full h-full" draggable="false" /></div>
                                <div className="col-span-3 h-44"><Image src={img4}  alt="" srcSet="" className="w-full h-full" draggable="false" /></div>
                            </div>
                        </div>
                    </div>
                </div>
