...
function FormInput({Icon,name,type,placeholder,extra}) {
    ...
    return (
        <div className="bg-white dark:bg-gray-700 p-3 dark:text-white rounded-md flex items-center gap-2 relative">
            ...
            <input name={name} type={formType} placeholder={placeholder} className="bg-transparent w-full border-0 absolute bottom-[1px] right-0 h-full pl-10 focus-within:outline-none" />
