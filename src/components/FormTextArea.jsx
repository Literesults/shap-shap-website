...
function FormTextArea({Icon,name,placeholder}) {
    ...
    return (
        <div className="bg-white dark:bg-gray-700 p-2 px-3 h-52 dark:text-white rounded-md flex gap-2 relative">
            ...
            <textarea cols="30" rows="10" name={name} placeholder={placeholder} className="bg-transparent py-2 resize-none w-full border-0 absolute bottom-[1px] right-0 h-full pl-10 focus-within:outline-none" />
        </div>
    )
}
